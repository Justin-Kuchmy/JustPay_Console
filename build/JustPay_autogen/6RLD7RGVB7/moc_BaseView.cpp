...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BaseView_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BaseView_t qt_meta_stringdata_BaseView = {
    {
        QT_MOC_LITERAL(0, 8)   // "BaseView"
    },
    "BaseView"
};
...
Q_CONSTINIT static const uint qt_meta_data_BaseView[] = {
...
Q_CONSTINIT const QMetaObject BaseView::staticMetaObject = { {
    ...
    qt_meta_stringdata_BaseView.offsetsAndSizes,
    qt_meta_data_BaseView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BaseView_t,
        // Q_OBJECT / Q_GADGET
