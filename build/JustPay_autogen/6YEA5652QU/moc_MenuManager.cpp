...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MenuManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MenuManager_t qt_meta_stringdata_MenuManager = {
    {
        QT_MOC_LITERAL(0, 11)   // "MenuManager"
    },
    "MenuManager"
};
...
Q_CONSTINIT static const uint qt_meta_data_MenuManager[] = {
...
Q_CONSTINIT const QMetaObject MenuManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_MenuManager.offsetsAndSizes,
    qt_meta_data_MenuManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MenuManager_t,
        // Q_OBJECT / Q_GADGET
